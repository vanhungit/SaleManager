...
{
    public partial class UC_LoiNhuanTheoNhomHang : UserControl
    {
        public UC_LoiNhuanTheoNhomHang()
        {
            InitializeComponent();
            ...
            gridLookUpEdit1.Properties.DataSource = new PRODUCT_GROUPController().PRODUCT_GROUP_GetList();
            gridLookUpEdit1.Properties.DisplayMember = "ProductGroup_Name";
            gridLookUpEdit1.Properties.ValueMember = "ProductGroup_ID";
        ...
        {
            gridControl1.DataSource = new STOCK_OUTWARDController().Report_ProfitbyProduct_Group(dateTu.DateTime, dateDen.DateTime, gridLookUpEdit1View.GetFocusedRowCellDisplayText("ProductGroup_ID").ToString());
