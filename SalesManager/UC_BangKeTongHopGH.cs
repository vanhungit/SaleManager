...
{
    public partial class UC_BangKeTongHopGH : UserControl
    {
        public UC_BangKeTongHopGH()
        {
            InitializeComponent();
            ...
            gridControl1.DataSource = new STOCK_OUTWARDController().DELIVERY_ORDER_GetList();
