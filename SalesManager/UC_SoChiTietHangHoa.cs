...
{
    public partial class UC_SoChiTietHangHoa : UserControl
    {
        public UC_SoChiTietHangHoa()
        {
            InitializeComponent();
            ...
            InitLookUp_KhoHang();
            gridControl1.DataSource = new INVENTORY_DETAILController().INVENTORY_DETAIL_SoCTHHoa(dateTu.DateTime, dateDen.DateTime, lookkho.GetColumnValue("Stock_ID").ToString(), "");
        }
