...
{
    public partial class UC_SanPhamNhapNhieu : UserControl
    {
        public UC_SanPhamNhapNhieu()
        {
            InitializeComponent();
        ...
        {
            gridControl1.DataSource = new PRODUCTController().Product_MaxQuantityImport(dateTu.DateTime, dateDen.DateTime);
        }
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                chartControl1.DataSource = new PRODUCTController().Product_ChartMaxQuantityImport(dateTu.DateTime, dateDen.DateTime, gridView1.GetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns[0]).ToString());
