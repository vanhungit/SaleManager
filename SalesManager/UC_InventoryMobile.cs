...
{
    public partial class UC_InventoryMobile : UserControl
    {
        public UC_InventoryMobile()
        {
            InitializeComponent();
        ...
        {
            gridControl1.DataSource = new InventoryMobileController().InventoryMobile_GetList();
        }
