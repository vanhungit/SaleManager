...
{
    public partial class UC_SanPhamDTCao : UserControl
    {
        public UC_SanPhamDTCao()
        {
            InitializeComponent();
        ...
        {
            gridControl1.DataSource = new PRODUCTController().Product_MaxAmountSale(dateTu.DateTime, dateDen.DateTime);
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (gridView1.RowCount > 0)
            {
                ...
                chartControl1.DataSource = new PRODUCTController().Product_ChartMaxAmountSale(dateTu.DateTime, dateDen.DateTime, gridView1.GetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns[0]).ToString());
