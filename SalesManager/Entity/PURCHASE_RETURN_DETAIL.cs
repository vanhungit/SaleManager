...
{
    public class PURCHASE_RETURN_DETAIL
    {
        ...
        private string _RefPurchase_ID = "";
        /// <summary>
        /// Mã đơn đặt hàng
        /// </summary>
        public string RefPurchase_ID
        {
            get { return _RefPurchase_ID; }
            set
            {
                _RefPurchase_ID = value;
            }
        }
        private string _RefInward_ID = "";
        /// <summary>
        /// Mã phiếu nhập kho
        /// </summary>
        public string RefInward_ID
        {
            get { return _RefInward_ID; }
            set
            {
                _RefInward_ID = value;
            }
