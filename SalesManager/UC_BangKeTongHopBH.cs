...
{
    public partial class UC_BangKeTongHopBH : UserControl
    {
        frmBanHang main_form;
        SYS_LOG _sys_log = new SYS_LOG();
        public UC_BangKeTongHopBH(frmBanHang _nhap, string _Timechon, DateTime _DateTimeFrom, DateTime _DateTimeTo, DataTable _table)
        {
            InitializeComponent();
            main_form = _nhap;
            ...
            _sys_log.Description = "Bảng Kê Phiếu Xuất";
        ...
        {
            WaitDialog.CreateWaitDialog("Đang tải dữ liệu ...", "Xem Bảng Kê Tổng Hợp");
            _sys_log.MChine = new MobilityNetwork().GetComputerName();
            _sys_log.IP = new MobilityNetwork().GetIP();
            _sys_log.UserID = "US000001";
            _sys_log.Created = DateTime.Now;
        ...
        private void barButtonItem3_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (gridView1.FocusedRowHandle >= 0)
            {
                ...
                _sys_log.Description = "Cập Nhật Bảng Kê Phiếu Xuất" + "-" + gridView1.GetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns[0]).ToString();
