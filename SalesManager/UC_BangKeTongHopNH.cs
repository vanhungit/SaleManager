...
{
    public partial class UC_BangKeTongHopNH : UserControl
    {
        frmNhapHang main_form;
        SYS_LOG _sys_log = new SYS_LOG();
        public UC_BangKeTongHopNH(frmNhapHang _nhap, string _Timechon, DateTime _DateTimeFrom, DateTime _DateTimeTo, DataTable _table)
        {
            InitializeComponent();
            main_form = _nhap;
            ...
            _sys_log.Description = "Bảng Kê Phiếu Nhập";
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            SYS_LOGController insertlog = new SYS_LOGController();
            insertlog.SYS_LOG_Insert(_sys_log);
            gridControl1.DataSource = new STOCK_INWARDController().STOCK_INWARD_GetList_ByDate(dateTu.DateTime, dateDen.DateTime, 0);
        ...
        private void barButtonItem6_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (gridControl1.DataSource != null)
                main_form.resetdataTH(cbochon.Text, dateTu.DateTime, dateDen.DateTime, ((DataTable)(gridControl1.DataSource)).Copy());
            else
        ...
        private void barButtonItem3_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (gridView1.FocusedRowHandle >= 0)
            {
                ...
                _sys_log.Description = "Cập Nhật Bảng Kê Phiếu Nhập" + "-" + gridView1.GetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns[0]).ToString();
