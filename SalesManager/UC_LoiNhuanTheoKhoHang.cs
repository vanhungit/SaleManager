...
{
    public partial class UC_LoiNhuanTheoKhoHang : UserControl
    {
        public UC_LoiNhuanTheoKhoHang()
        {
            InitializeComponent();
        ...
        {
            gridControl1.DataSource = new STOCK_OUTWARDController().Report_ProfitbyStockID(dateTu.DateTime, dateDen.DateTime, gridLookUpEdit1View.GetFocusedRowCellDisplayText("Stock_ID").ToString());
