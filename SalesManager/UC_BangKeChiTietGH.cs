...
{
    public partial class UC_BangKeChiTietGH : UserControl
    {
        public UC_BangKeChiTietGH()
        {
            InitializeComponent();
            ...
            gridControl1.DataSource = new STOCK_OUTWARD_DETAILController().DELIVERY_ORDER_DETAIL_Getall();
