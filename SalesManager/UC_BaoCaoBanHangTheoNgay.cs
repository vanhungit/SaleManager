...
{
    public partial class UC_BaoCaoBanHangTheoNgay : UserControl
    {
        public UC_BaoCaoBanHangTheoNgay()
        {
            InitializeComponent();
            ...
            gridControl1.DataSource = new STOCKController().REPORT_DOANHTHUBH_BYDATE(dateTu.DateTime, dateDen.DateTime);
        }
