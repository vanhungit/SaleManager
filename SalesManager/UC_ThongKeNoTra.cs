...
{
    public partial class UC_ThongKeNoTra : UserControl
    {
        public UC_ThongKeNoTra()
        {
            InitializeComponent();
            ...
            gridLookUpEdit1.Properties.DataSource = new PROVIDERController().PROVIDER_GetList();
        ...
        {
            gridControl1.DataSource = new DEBTController().Debt_CongNoTra(dateTu.DateTime, dateDen.DateTime, gridLookUpEdit1View.GetFocusedRowCellDisplayText("Customer_ID").ToString()); ;
