...
{
    public partial class UC_TransactionKhoCT : UserControl
    {
        public UC_TransactionKhoCT()
        {
            InitializeComponent();
            ...
            gridControl1.DataSource = new INBOUND_DELIVERY_DETAILController().NKTP_TRUNGGIAN_DETAIL_Get();
        }
