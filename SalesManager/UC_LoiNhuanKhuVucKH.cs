...
{
    public partial class UC_LoiNhuanKhuVucKH : UserControl
    {
        public UC_LoiNhuanKhuVucKH()
        {
            InitializeComponent();
            ...
            gridLookUpEdit1.Properties.DataSource = new CUSTOMER_GROUPController().LayDSCUSTOMER_GROUP();
        ...
        {
            gridControl1.DataSource = new STOCK_OUTWARDController().Report_ProfitbyCustomerGroup(dateTu.DateTime, dateDen.DateTime, gridLookUpEdit1View.GetFocusedRowCellDisplayText("Customer_Group_ID").ToString());
        }
