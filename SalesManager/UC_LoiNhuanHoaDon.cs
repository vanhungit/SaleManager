...
{
    public partial class UC_LoiNhuanHoaDon : UserControl
    {
        public UC_LoiNhuanHoaDon()
        {
            InitializeComponent();
        ...
        {
            gridControl1.DataSource = new STOCK_OUTWARDController().Report_ProfitbyInvoice(gridLookUpEdit1.Text);
        }
