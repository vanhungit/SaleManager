...
{
    public partial class UC_LoiNhuanKhachHang : UserControl
    {
        public UC_LoiNhuanKhachHang()
        {
            InitializeComponent();
            ...
            //gridLookUpEdit1.EditValue = gridLookUpEdit1View.GetFocusedRowCellDisplayText("CustomerName").ToString();
        }
        ...
        {
            gridControl1.DataSource = new STOCK_OUTWARDController().Report_ProfitbyCustomerID(dateTu.DateTime, dateDen.DateTime, gridLookUpEdit1View.GetFocusedRowCellDisplayText("Customer_ID").ToString()); ;
        }
