...
{
    public partial class UC_SanPhamDSNhapNhieu : UserControl
    {
        public UC_SanPhamDSNhapNhieu()
        {
            InitializeComponent();
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (gridView1.RowCount > 0)
            {
                ...
                chartControl1.DataSource = new PRODUCTController().Product_ChartMaxAmountImport(dateTu.DateTime, dateDen.DateTime, gridView1.GetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns[0]).ToString());
                chartControl1.SeriesDataMember = "ProductName";
                chartControl1.SeriesTemplate.ArgumentDataMember = "Thang";
                chartControl1.SeriesTemplate.ValueDataMembers.AddRange(new string[] { "TongSL" });
                chartControl1.SeriesSorting = SortingMode.None;
                chartControl1.SeriesTemplate.SeriesPointsSorting = SortingMode.None;
            }
        }

        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            gridControl1.DataSource = new PRODUCTController().Product_MaxAmountImport(dateTu.DateTime, dateDen.DateTime);
        }
    }
}
