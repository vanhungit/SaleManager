...
{
    public class RETURN_ORDER_DETAILController
    {
        private List<RETURN_ORDER_DETAIL> MapRETURN_ORDER_DETAIL(DataTable dt)
        {
            List<RETURN_ORDER_DETAIL> rs = new List<RETURN_ORDER_DETAIL>();
            for (int i = 0; i < dt.Rows.Count; i++)
            {

                RETURN_ORDER_DETAIL obj = new RETURN_ORDER_DETAIL();
