...
{
    public class PURCHASE_RETURNController
    {
        private List<PURCHASE_RETURN> MapPURCHASE_RETURN(DataTable dt)
        {
            List<PURCHASE_RETURN> rs = new List<PURCHASE_RETURN>();
        ...
        public string PURCHASE_RETURN_Search(string UserName)
        {
            DataTable dt = new DataTable();
            try
            {
                DataProvider.FillDataTable(DataProvider.ConnectionString, dt, "PurchaseReturn_Search", "%" + UserName + "%");
        ...
        public int PURCHASE_RETURN_Insert(PURCHASE_RETURN obj)
        {
            try
            {
                return DataProvider.ExecuteNonquery(DataProvider.ConnectionString, "PURCHASE_RETURN_Insert",
                     obj.ID
                   , obj.RefDate
                   , obj.Ref_OrgNo
                   , obj.Ref_Inward
