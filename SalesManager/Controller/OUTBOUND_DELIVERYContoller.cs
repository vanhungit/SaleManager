...
{
    public class OUTBOUND_DELIVERYContoller
    {
        private List<OUTBOUND_DELIVERY> MapINBOUND_DELIVERY(DataTable dt)
        {
            List<OUTBOUND_DELIVERY> rs = new List<OUTBOUND_DELIVERY>();
            for (int i = 0; i < dt.Rows.Count; i++)
            {

                OUTBOUND_DELIVERY obj = new OUTBOUND_DELIVERY();
