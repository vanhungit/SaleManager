...
{
    public partial class UC_LoiNhuanTheoMatHang : UserControl
    {
        public UC_LoiNhuanTheoMatHang()
        {
            InitializeComponent();
            ...
            gridLookUpEdit1.Properties.DataSource = new PRODUCTController().PRODUCT_GetList();
        ...
        {
            gridControl1.DataSource = new STOCK_OUTWARDController().Report_ProfitbyProduct_ID(dateTu.DateTime, dateDen.DateTime, gridLookUpEdit1View.GetFocusedRowCellDisplayText("Product_ID").ToString());
